...
<div class="container-fluid">    
  <div class="row">
                 ...
                 <form action="#" class="form-horizontal">
                  <div class="row">
                     <legend align="center">Login Your Account</legend>
                     <div class="col-md-8">
      ...
      <button type="submit" class="btn btn-success" name="btn"><a href="item_list.cfm">Login</a></button>
       <button type="Reset" class="btn btn-success" name="btn1">Reset</button>
      </div>
  </div>
</div>
</form>      
